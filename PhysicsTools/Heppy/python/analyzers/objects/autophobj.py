...
metType = NTupleObjectType("met", baseObjectTypes = [ fourVectorType ], variables = [
    ...
    NTupleVariable("corrPt",  lambda x : x.corPt(ROOT.pat.MET.Type01XY) ),
    NTupleVariable("corrPhi", lambda x : x.corPhi(ROOT.pat.MET.Type01XY) ),
    NTupleVariable("corrSumEt", lambda x : x.corSumEt(ROOT.pat.MET.Type01XY) ),
